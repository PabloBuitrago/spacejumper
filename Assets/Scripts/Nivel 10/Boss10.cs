...
public class Boss10 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Invoco la funcion Generar pasado 6 segundos (para que empiece a disparar cuando se vea por pantalla).
        Invoke("Generar", 6);
    ...
    public void DecrementarVida()
    {
        ...
        vidasBoss.text = "10 - " + vidas.ToString();
    }
